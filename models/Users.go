...
type User struct {
	...
	HighScore null.Int `boil:"high_score" json:"high_score,omitempty" toml:"high_score" yaml:"high_score,omitempty"`
	Coin      null.Int `boil:"coin" json:"coin,omitempty" toml:"coin" yaml:"coin,omitempty"`
...
var UserWhere = struct {
	...
	HighScore whereHelpernull_Int
	Coin      whereHelpernull_Int
}{
	ID:        whereHelperint{field: "`Users`.`id`"},
	UserName:  whereHelperstring{field: "`Users`.`user_name`"},
	HighScore: whereHelpernull_Int{field: "`Users`.`high_score`"},
	Coin:      whereHelpernull_Int{field: "`Users`.`coin`"},
}
...
var (
	userAllColumns            = []string{"id", "user_name", "high_score", "coin"}
	userColumnsWithoutDefault = []string{"user_name"}
	userColumnsWithDefault    = []string{"id", "high_score", "coin"}
